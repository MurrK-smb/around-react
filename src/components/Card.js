...
function Card({ card, onCardClick, onDeleteClick}) {
  ...
  const cardLikeButtonClassName = (`card__like-button ${isLiked && 'card__like-button__a'}`)
  ...
  return (
    <div className="card">
      <button className={cardDeleteButtonClassName} type="button" onClick={onDeleteClick}></button>
